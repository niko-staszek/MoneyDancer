//+------------------------------------------------------------------+
//| Globals.mqh â€” runtime state variables                            |
...
//==================== SERIES STATE (A5.2) ====================
// Series IDs identify a "basket generation" â€” every new series increments the
...
// â€” per-series equity snapshot at series open + SL-fired flag + daily counter.
...
// Period stats (today / week / month Ă— long / short). Counts + profit sums.
...
// "AI" simulation â€” cosmetic status + confidence widget
...
// Bottom-panel M15 bucketed PnL (96 slots = 24h Ă— 4)
double   g_m15Pnl[96];
int      g_pnlDayKey        = -1;
