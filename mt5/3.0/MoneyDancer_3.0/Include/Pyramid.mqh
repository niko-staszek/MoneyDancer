//+------------------------------------------------------------------+
//| Pyramid.mqh â€” pyramid bookkeeping + management                   |
//| Phase A5.2                                                       |
//|                                                                   |
...
//|                                                                   |
//| MT5 adaptations: tickets are ulong; OrderSelectâ†’PositionSelect;   |
//| Digits/Point â†’ _Digits/_Point; StringConcatenateâ†’+.               |
//+------------------------------------------------------------------+
#ifndef __MD_PYRAMID_MQH__
#define __MD_PYRAMID_MQH__

// Forward declaration â€” defined in Series.mqh (A5.3). Used by PyramidManage
...
// PLAN Â§19; scalper is prop-OFF so compliance window doesn't apply.
