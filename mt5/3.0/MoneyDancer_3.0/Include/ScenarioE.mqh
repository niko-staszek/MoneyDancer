//+------------------------------------------------------------------+
//| ScenarioE.mqh â€” hedge "runner" positions + siphon logic          |
//| Phase A5.5                                                       |
//|                                                                   |
...
//|  - SendOrder is forward-declared â€” defined in Signal.mqh (A5.6). |
//+------------------------------------------------------------------+
#ifndef __MD_SCENARIOE_MQH__
#define __MD_SCENARIOE_MQH__

// Forward declaration â€” defined in Signal.mqh (A5.6)
...
//| (forward-declared â€” defined in Signal.mqh).                       |
//+------------------------------------------------------------------+
...
void ScenarioE_ScanNewRunnerClosures()
{
   ...
   for(int i = g_lastDealsCount; i < totalDeals; i++)
   {
      ...
      //   closing a BUY position â†’ DEAL_TYPE_SELL â†’ runner was +1
      //   closing a SELL position â†’ DEAL_TYPE_BUY  â†’ runner was -1
