//+------------------------------------------------------------------+
//| Persistence.mqh â€” PosMem tracking (save/load/sync)                |
...
//|    PositionSelectByTicket â€” cleanly returns false for closed      |
...
//| into a reference first argument and returns the length â€” so we    |
