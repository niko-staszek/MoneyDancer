"""S5.5c regime-aware lot scaling — 4 combos × 5 cells."""
import yaml
...
COMBOS = {
    "C1": "Range=0.5 Trend=1.0",
    "C2": "Range=1.0 Trend=1.5",
    "C3": "Range=0.5 Trend=1.5",
    "C4": "Range=1.5 Trend=0.5",
}

def load(combo, cell):
    p = Path(f"runs/LOT_{combo}-5k-{cell}/result.yaml")
    if p.exists():
